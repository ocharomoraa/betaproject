...
<body>
  ...
  <?php 
    ...
    <h2 style="margin-left: 110px;">List of Orders</h2>
  ...
  */
    ...
    if ($result) {
      ...
      if ($rows>0) {
        ...
        while($record = mysqli_fetch_assoc($result)){
           ...
           // echo "<td>".$record['id']."</td>";
            ...
            <form method='POST' action=''>
              <a href='index.php?id=".$record['id']."' class='btn btn-success'>Deliver</a> 
              <a href='index.php?id=".$record['id']."' class='btn btn-success'>Cancel</a>  
              </form>
            </td>";
            echo "</tr>";
        }
        ...
        echo "<h4>No Orders available</h4>";
      }
    }else{
